"""
=============================================================================================================
Python script to demonstrates a creative writer that uses a neural language model
=============================================================================================================
...
class CreativeWriter:
    ...
    def train_model(self) -> None:
        ...
        if self.model is None or self.X_train is None:
            print("ERROR: Model or training data not initialised")
            return

        # Cross-entropy loss is the standard choice for classification tasks.
        # Predicting the next word is a classification problem over the vocabulary.
