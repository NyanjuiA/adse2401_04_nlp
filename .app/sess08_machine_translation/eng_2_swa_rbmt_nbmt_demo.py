"""
=============================================================================================================
Python script to demonstrates machine based translation using RBMT & NBMT
=============================================================================================================
...
REFERENCE_TRANSLATION: list[str] = [
    ( "Mwisho wa msimu wa vuli uliopita, nilisafiri kwa treni kutoka Manchester hadi Edinburgh "
      "kumtembelea rafiki wa chuo kikuu wa zamani ambaye sikuwa nimemwona kwa miaka kadhaa. "
      "Safari ilianza asubuhi sana, na kituo tayari kilikuwa kimejazwa na abiria wakiwa na vikombe "
      "vya kahawa na mikoba ya ofisi. Ingawa hali ya hewa ilitabiri mvua kubwa mwingi wa siku, anga "
      "lilabaki safi kwa mshangao kwa sehemu kubwa ya safari. Nilitumia sehemu ya safari nikisoma "
      "riwaya ya kihistoria na mara kwa mara kutazama nje ya dirisha katika mandhari yanayobadilika. "
      "Wakati treni ilipokuwa ikielekea kaskazini, milima ilikua mikali zaidi na vijiji vilionekana vidogo "
      "na kimya. Familia moja iliyokaa karibu ilijadiliana mipango yao ya likizo kwa undani mkubwa, jambo "
      "ambalo lilitoa burudani isiyotarajiwa wakati wa safari ya muda mrefu. Wakati nilipofika hatimaye Edinburgh, "
      "nilihisi kuchoka na pia furaha kuhusu kutumia wikendi kuchunguza mji tena."
      ),
    (
        "Mnamo Desemba, nilisafiri kwa basi kutoka Nairobi hadi Arusha kuhudhuria mkoa" 
        "mkutano wa kibiashara uliowaleta pamoja wajasiriamali vijana kutoka Mashariki mwa nchi" 
        ...
        "abiria walibaki wavumilivu na kuendelea kuzungumza katika muda wote wa kuchelewa. Nilitumia" 
        "sehemu kubwa ya safari ya kusikiliza muziki, kujibu ujumbe kwenye simu yangu, na" 
        "kuangalia mabadiliko ya mazingira nje ya dirisha. Tuliposafiri zaidi" 
        "kusini, niliona mashamba makubwa, masoko ya kando ya barabara, na vikundi vya waendesha baiskeli vikitembea" 
        ...
        "alifika Arusha majira ya jioni, mitaa ilikuwa imechangamka na wafanyabiashara," 
...
class NeuralTranslator:
    ...
    def _load_model(self) -> None:
        ...
        # Store as a simple namespace for convinience
