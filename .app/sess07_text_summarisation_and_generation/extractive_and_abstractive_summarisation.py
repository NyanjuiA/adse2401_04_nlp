...
This script demonstrates extractive summarisation, abstractive summarisation, and text generation using
...
def main():
    ...
    # --------------------------------------------------------------------------------
    print_heading("ABSTRACTIVE SUMMARISATION")
    abstractive = AbstractSummariser()
